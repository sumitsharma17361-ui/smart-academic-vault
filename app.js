...
async function fetchNotes() {
    ...
    try {
        ...
        if (!notes || notes.length === 0) {
            container.innerHTML = `<p class="text-xs text-gray-400 text-center py-4">Abhi koi notes uplabdh nahi hain.</p>`;
            return;
        }
        ...
        container.innerHTML = `<p class="text-xs text-red-400 text-center py-4">Backend connect nahi ho pa raha hai.</p>`;
    }
}
